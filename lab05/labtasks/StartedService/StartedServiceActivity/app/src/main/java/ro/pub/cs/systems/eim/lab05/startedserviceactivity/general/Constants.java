...
public interface Constants {
    ...
    final public static String SERVICE_PACKAGE_NAME = "ro.pub.cs.systems.eim.lab05.startedservice";
    final public static String SERVICE_CLASS_NAME = SERVICE_PACKAGE_NAME + ".service.StartedService";
