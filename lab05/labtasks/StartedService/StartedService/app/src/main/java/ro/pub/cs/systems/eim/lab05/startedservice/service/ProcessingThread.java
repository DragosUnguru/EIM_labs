...
public class ProcessingThread extends Thread {
    ...
    private void sendMessage(int messageType) {
        ...
        switch (messageType) {
            ...
            case Constants.MESSAGE_ARRAY_LIST:
                ...
                break;
            default:
                Log.d(Constants.TAG, "ProcessingThread::sendMessage > Invalid message type requested: " + messageType);
        }
    ...
    private void sleep() {
        try {
            ...
            Log.e(Constants.TAG, "ProcessingThread::sleep > Sleep interrupted. Exception: " + e.getMessage());
        }
    }
}
