...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if (savedInstanceState.containsKey(Constants.USERNAME_EDIT_TEXT)) {
                EditText usernameCallback = (EditText) findViewById(R.id.username_edit_text);
                usernameCallback.setText(savedInstanceState.getString(Constants.USERNAME_EDIT_TEXT));
            }
            if (savedInstanceState.containsKey(Constants.PASSWORD_EDIT_TEXT)) {
                EditText passwordCallback = (EditText) findViewById(R.id.password_edit_text);
                passwordCallback.setText(savedInstanceState.getString(Constants.USERNAME_EDIT_TEXT));
            }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        if (checkBox.isChecked()) {
            ...
            outState.putString(Constants.USERNAME_EDIT_TEXT, usernameCallback.getText().toString());
            outState.putString(Constants.PASSWORD_EDIT_TEXT, passwordCallback.getText().toString());
        }
    }
